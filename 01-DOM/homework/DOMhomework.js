...
// Tu codigo acá:
var toDoItems = []; //sirve para agregar las tareas
...
let creadoXmi = document.querySelector('#createdBy');
creadoXmi.innerHTML = creadoXmi.innerHTML + 'Yotas';



/* var span = document.getElementById('createdBy')
span.innerHTML = span.innerHTML + 'Felipe!' */
